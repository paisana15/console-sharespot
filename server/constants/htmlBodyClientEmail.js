export const htmlBodyClientEmail = (firstname, lastname, amount) => {
  return `
    <!doctype html>
            ...
            <p style="text-align: center; line-height: 125%;"><span style="font-size:13px">Realizamos o pagamento de ${amount} HNT para a tua conta digital.<br>
