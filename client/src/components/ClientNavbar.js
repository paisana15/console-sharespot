        ...
        <Flex as="nav" className='navbar' justify="space-between" wrap="wrap">
          ...
          <div className="wrapper-navbar">
            ...
            >
              ...
              <MenuItems>
                <span className="d-flex d-lg-none mt-4 ml-1" onClick={logoutHandler}>
                  <i
                    className="sign-out-icon fas fa-sign-out-alt mr-3"
                  ></i>
                  Sign out
                </span>
              </MenuItems>
            ...
            <div className="d-flex d-lg-none">
              <MenuItems>
                <span className="d-none d-lg-flex" onClick={logoutHandler}>
                  <i
                    className="sign-out-icon fas fa-sign-out-alt mr-3"
                  ></i>
                  Sign out
          ...
          <div className="d-none d-lg-flex">
              <MenuItems>
                <span className="d-none d-lg-flex mr-3" onClick={logoutHandler}>
                  Sign out
                  <i
                    className="sign-out-icon fas fa-sign-out-alt ml-2"
                  ></i>
                </span>
              </MenuItems>
              <IconButton
